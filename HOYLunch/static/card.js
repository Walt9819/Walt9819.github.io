...
const dulce = [
    ...
    <ProductCard id="4" image={imsUrls["4"]} title="Poporopos" description="Deliciosos Poporopos de diferentes sabores" prize="" location="Mesitas de abajo" phoneNumber="524425598073" />,
];
